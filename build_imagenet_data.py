...
tf.app.flags.DEFINE_string('output_directory', './ImageNet_data/',
...
tf.app.flags.DEFINE_integer('num_threads', 100,
                            'Number of threads to preprocess the images.')

# The wnids.txt (labels_file) contains a list of valid labels are held in this file.
...
# The words.txt file containing mapping from synset to human-readable label.
...
def _process_dataset(name, directory, num_shards, synset_to_human):
  ...
  Args:
    ...
    synset_to_human: dict of synset to human labels, e.g.,
      'n02119022' --> 'red fox, Vulpes vulpes'
  """
  print("Processing shards of ",name)
